package com.manibhadra.multipleFileUpload;
...
import com.manibhadra.serverTask.API;
...
public class MultiPartRequest extends Request<String> {
    ...
    public MultiPartRequest(Response.ErrorListener errorListener, Response.Listener listener, ArrayList<File> file, int numberOfFiles, Map<String, String> params, Activity profileActivity) {
        super(Method.POST, API.BASE_URL+"user/updateProfile", errorListener);
        mListener = listener;
        mParams=params;
        mHttpEntity = buildMultipartEntity(file, numberOfFiles);
        session = new SessionManager(profileActivity.getBaseContext());
